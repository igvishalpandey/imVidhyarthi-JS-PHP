...
$sno = 1;
// $query3= "SELECT * FROM students_details JOIN subject_detail where students_details.email= subject_detail.email AND class= '$_SESSION[class]' AND year= $_SESSION[year]; AND $_SESSION[subject]";
    ...
    <body id="feature-attendance-coursewise">
        <section>
            <div id="attendance-head">
                <h1 style="font-size: 2rem;">Attendance (<?php echo "$SESSION[class]"; ?>):</h1>
                <h1 style="font-size: 2rem;"> (<?php echo "$SESSION[Year]"; ?>):</h1>
            </div>
            <div>
