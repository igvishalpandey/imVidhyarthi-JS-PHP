    ...
    <header>
        <nav id="navbar">
            <div id="logo-txt">
                ...
                <h1><a href="index.php">ImVidhyarthi.in</a></h1>
            </div>
            <div>
                <ul id="right-navbar">
                    <li><a href="login.php" class="login-system-links">LogIn</a></li>
                    <li><a href="signup.php" class="login-system-links">SignUp</a></li>
                </ul>
            </div>
        </nav>
    </header>
