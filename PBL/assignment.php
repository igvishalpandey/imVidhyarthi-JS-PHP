...
$temp_query= "SELECT class FROM students_details WHERE email= '$_SESSION[email]';";
$temp_result= mysqli_query($conn, $temp_query);
$arr= mysqli_fetch_assoc($temp_result);
$class= $arr['class'];

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $year = $_POST['year'];
    $query = "SELECT * FROM assignment WHERE class='$_SESSION[email]' AND year='$year';";
            ...
            <table>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <div class="container">
                                <button type="button" id="upload-assignment-btn" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Update Assignment</button>
