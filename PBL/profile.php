...
$sql = "SELECT * FROM students_details JOIN users WHERE students_details.email= users.email AND users.email= '$_SESSION[email]';";
                ...
                <div id="profile-features-box">
                    ...
                    <div id="profile-details">
                        ...
                        <div class="sub-profile-details">
                            ...
                            <p><span><?php echo "$row[sysid]" ?></span></p>
                        </div>
                        <div class="sub-profile-details">
                        ...
                        <div class="sub-profile-details">
                            <h5>Father Name: </h5>
                            <p><span><?php echo "$row[father_name]" ?></span></p>
                        </div>
                        <div class="sub-profile-details">
                            <h5>User Id: </h5>
                            <p><span><?php echo "$row[sysid]" ?></span></p>
                        ...
                        <div class="sub-profile-details">
                            <h5>Roll no.: </h5>
                            <p><span><?php echo "$row[rollno]" ?></span></p>
                        </div>
                        <div class="sub-profile-details">
                            <h5>Class: </h5>
                            <p><span><?php echo "$row[class]" ?></span></p>
                        </div>
                        <div class="sub-profile-details">
                            <h5>Address: </h5>
...
if(isset($_POST["update-profile-picture"])){
    ...
    if(file_exists("profile-pictuers". $_FILES['profile-picture']['name'])){
        ...
        $query= "UPDATE users SET img='$update_filename' WHERE email= '$email';";
