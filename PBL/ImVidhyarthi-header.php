                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="navbar-list-itmes">
                            <?php
                            $sql = "SELECT * FROM students_details WHERE email= '$_SESSION[email]'";
                            $result = mysqli_query($conn, $sql);
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) { ?>

                                    <p class="dropdown-details">System ID: <?php echo "$row[sysid]" ?></p>
                                    <p class="dropdown-details">Roll no: <?php echo "$row[rollno]" ?></p>
                                    <p class="dropdown-details">Course: <?php echo "$row[course]" ?></p>
                        ...
                        <li class="navbar-list-items"><a class="dropdown-item" href="profile.php">Profile</a></li>
